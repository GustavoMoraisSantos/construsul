...
export default function Hero() {
  return (
    <section id="inicio" className="relative overflow-hidden bg-white pt-28 md:pt-36">
      <div
        aria-hidden="true"
      ...
      <div className="container-px relative grid items-center gap-12 pb-20 md:grid-cols-2 md:pb-28">
        <div className="animate-fade-in-up">
          ...
          <h1 className="text-3xl font-extrabold leading-tight text-ink sm:text-4xl md:text-5xl">
            ...
            <span className="text-brand">construção civil</span> em Corumbataí do Sul
          </h1>
          ...
          <ul className="mt-10 grid grid-cols-2 gap-3 sm:max-w-lg">
            {heroBadges.map((badge) => (
              <li
                key={badge}
                className="rounded-xl border border-line bg-cloud px-4 py-3 text-sm font-medium text-ink"
              >
                {badge}
              </li>
            ))}
